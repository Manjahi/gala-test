...
const PARTICIPANTS_DATA = {
  ...
  "E101": { // Event 101: Girls 8 & Under 17 Backstroke Kickboard
    ...
    participants: [
      { lane: 2, name: "Naisenya Njeri", house: "Mara" },
      { lane: 3, name: "Heavenly Nyambura", house: "Samburu" },
      { lane: 4, name: "Amara Ngatha", house: "Amboseli" },
      { lane: 5, name: "Kellyann Njeri", house: "Tsavo" },
      { lane: 6, name: "Naya Nduku", house: "Aberdare" }
    ]
  },
  "E102": { // Event 102: Boys 8 & Under 17 Backstroke Kickboard
    ...
    participants: [
      { lane: 2, name: "Myles Karanja", house: "Mara" },
      { lane: 3, name: "Heri Mugwe", house: "Samburu" },
      { lane: 4, name: "Jayson Kamau", house: "Amboseli" },
      { lane: 5, name: "Lucius Kiongo", house: "Tsavo" },
      { lane: 6, name: "Alfred Njuguna", house: "Aberdare" }
    ]
  },
  "E103": { // Event 103: Girls 8 & Under 17 Freestyle Kickboard
    ...
    category: "Girls 8 & Under",
    participants: [
      { lane: 2, name: "Neema Thayu", house: "Mara" },
      { lane: 3, name: "Gift Wanjiru", house: "Samburu" },
      { lane: 4, name: "Mitchelle Wambui", house: "Amboseli" },
      { lane: 5, name: "Valentine Wacera", house: "Tsavo" },
      { lane: 6, name: "Leticia Kasiva", house: "Aberdare" }
    ]
  },
  "E104": { // Event 104: Boys 8 & Under 17 Freestyle Kickboard
    ...
    participants: [
      ...
      { lane: 2, name: "Heri Mugwe", house: "Samburu" },
      { lane: 3, name: "Sheeran Salim", house: "Amboseli" },
      { lane: 4, name: "Albert Ungaya", house: "Tsavo" },
      { lane: 5, name: "Liam Arthur", house: "Aberdare" }
    ]
  },
  "E105": { // Event 105: Girls 8 & Under 25 Freestyle Kickboard
    ...
    participants: [
      ...
      { lane: 3, name: "Amara Ngatha", house: "Amboseli" },
      { lane: 4, name: "Nuru Njeri", house: "Tsavo" },
      { lane: 5, name: "Marion Muthoni", house: "Aberdare" }
    ]
  },
